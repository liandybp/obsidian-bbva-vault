...
aliases:
  - copilot_intucciont
  - COPILOT_INTUCCIONT
  - COPILOT_INSTRUCTIONS_LEGACY
  - DEPRECATED_COPILOT_INSTRUCTIONS
status: ARCHIVED
---

# ⚠️ DEPRECATED: Instrucciones para GitHub Copilot (LEGACY)

> **ARCHIVO ARCHIVADO.** La versión activa vive en [[kpfm/proyectos/kpfm-etiquetas/contexto/COPILOT_INSTRUCTIONS]].
> 
> Este archivo se mantiene solo como referencia histórica. **NO USAR PARA NUEVAS SESIONES.**

## 📌 Acción Requerida

Para **sesiones futuras sobre kpfm-etiquetas**, consultar:
- ✅ **Activa (proyecto):** [[kpfm/proyectos/kpfm-etiquetas/contexto/COPILOT_INSTRUCTIONS]]
- ✅ **Estado actual:** [[kpfm/proyectos/kpfm-etiquetas/ESTADO]]
- ✅ **Global:** [[_global/copilot/INSTRUCCIONES_BASE]]
- ✅ **Convención de links:** [[_global/standards/WIKILINKS_CONVENCION]]

---

## 📚 Contenido Archivado (Referencia Histórica)
...
TAG_ENTRY_SCHEMA = StructType([
    ...
    ("gf_pfm_tag_updated_date", TimestampType()),           # [3] NUEVO: Fecha de actualización (null si no hay cambios)
...
**Inicio de Sesión:**
1. Revisar este archivo (COPILOT_INSTRUCTIONS.md)
2. Leer `/contexto/CONTEXTO_ACTUAL.md`
3. Revisar cambios recientes en `/decisiones/`

**Durante Implementación:**
1. Respetar nombre variables: `label_id`, `LABELS_PARAM`, etc.
2. Usar Spark Column DSL (no Pandas UDF)
3. Incluir tests al mismo tiempo que código
4. Documentar decisiones importantes

**Finalización:**
1. Ejecutar `pytest -q` y verificar paso
2. Actualizar `/contexto/CAMBIOS_RECIENTES.md`
3. Documentar decisiones de diseño si aplica

---

**Última Sesión:** 29 Junio 2026
**Estado:** Tag merging + gf_pfm_tag_updated_date ✅ completado
